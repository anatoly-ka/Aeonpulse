...
namespace Aeonpulse.ViewModels
{
    ...
    public class LocalizedResources : INotifyPropertyChanged
    {
        ...
        public string Chart_VibrantNature_Discoveries    => AppResources.Chart_VibrantNature_Discoveries;
        public string Chart_VibrantNature_Extinctions    => AppResources.Chart_VibrantNature_Extinctions;
        public string Chart_VibrantNature_LabelInsectsIn  => AppResources.Chart_VibrantNature_LabelInsectsIn;
        public string Chart_VibrantNature_LabelPlantsIn   => AppResources.Chart_VibrantNature_LabelPlantsIn;
        public string Chart_VibrantNature_LabelVertsIn    => AppResources.Chart_VibrantNature_LabelVertsIn;
        public string Chart_VibrantNature_LabelOthersIn   => AppResources.Chart_VibrantNature_LabelOthersIn;
        public string Chart_VibrantNature_LabelInsectsOut => AppResources.Chart_VibrantNature_LabelInsectsOut;
        public string Chart_VibrantNature_LabelVertsOut   => AppResources.Chart_VibrantNature_LabelVertsOut;
        public string Chart_VibrantNature_LabelOthersOut  => AppResources.Chart_VibrantNature_LabelOthersOut;
