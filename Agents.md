...
TIMER (every 1 second, thread-pool thread)
    ...
    --> System.Timers.Timer.Elapsed
            --> MainThread.BeginInvokeOnMainThread(UpdateLiveCalculations)
                    ...
                    --> LiveBadgeOpacity toggle    --> all LIVE badge Label opacities repaint
